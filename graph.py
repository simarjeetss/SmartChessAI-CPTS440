...
class Graph:
    ...
    def __init__(self, model_name, opponent="all"):
        ...
        self.filepath_evaluation_scores = "saves/" + model_name + "/ChessAi_evaluation_scores.pkl"
        self.filepath_graph = "saves/" + model_name + "/ChessAi_training_graph_" + model_name + ".pdf"
        self.filepath_graph_checkpoint = "saves/" + model_name + "/ChessAi_training_graph_" + model_name + "_checkpoint.pdf"
